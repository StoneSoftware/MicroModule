...
import org.stone.software.helper.object.ObjectHelper;
...
public interface SupserMapper<T>
{
    ...
    public default void insert(String table, T obj, boolean isInhert)
    {
        ...
        List<Field> fields = ObjectHelper.getObjectField(clazz, isInhert);
        ...
        try
        {
            for (Field field : fields)
            {
                ...
                String b =
                    field.getName()
                        .replaceFirst(a, a.toLowerCase(Locale.CHINA));
                Method getMethod;
