...
@Configuration
public class CorsConfigRegistryFilter
{
    /*
     ...
     * config); // CORS 配置对所有接口都有效 FilterRegistrationBean bean = new
     * FilterRegistrationBean(new CorsFilter(source)); bean.setOrder(0); return
     * bean; }
     */
}
